...
a persistence unit "tvsPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "tvs\pom.xml":
...
artifact ("tvs.war") is already built. You can build
